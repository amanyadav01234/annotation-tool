...
const drawWatermark = (ctx: CanvasRenderingContext2D, settings: UtilsSettings) => {
  ctx.save()
  ctx.font = '12px sans-serif'
  ctx.fillStyle = 'rgba(100, 100, 100, 0.4)'
  ctx.textAlign = 'right'
  ctx.textBaseline = 'bottom'
  ctx.fillText('Aman Paint • Aman Yadav', settings.canvasSize.width - 12, settings.canvasSize.height - 10)
  ctx.restore()
}
...
const renderDrawCanvas = (
  ...
  drawWatermark(drawCtx, settings)
}
