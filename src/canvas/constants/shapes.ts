...
export const SHAPES_WITH_ROTATION = ['rect', 'square', 'circle', 'ellipse', 'picture', 'text', 'triangle', 'star', 'brush', 'group']
export const SHAPES_KEEPING_RATIO = ['square', 'circle', 'star', 'picture', 'text']
