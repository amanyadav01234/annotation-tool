...
<div className="sb-container">
  ...
  <div className="sb-section">
    <div className="sb-section-item">
      ...
      <Source language='bash' code={`npm install @aman-yadav/react-paint`}/>
      <Source language='bash' code={`yarn add @aman-yadav/react-paint`}/>
      <Source language='bash' code={`pnpm add @aman-yadav/react-paint`}/>
      ...
      <p>
        Don't forget to import the CSS file in your application:
            ...
            <Source language='typescript' code={`import '@aman-yadav/react-paint/react-paint.css'`}/>
      ...
      <Source language='typescript' code={`import { Canvas, Editor, useReactPaint } from '@aman-yadav/react-paint'
...
link.click()`} />
    ...
    <Source language='typescript' code={`const { editorProps, canvasProps } = useReactPaint({
      ...
      <ul>
        ...
        <li>Visit the <a href="https://github.com/aman-yadav/react-paint" target="_blank">GitHub repository</a> for more examples and contributions</li>
      </ul>
    </div>
  </div>
</div>
